...
class MultiApp:
    ...
    def run(self):
        ...
        st.sidebar.info(
            ...
            "[issues](https://github.com/giswqs/timelapse/issues) or "
            "[pull requests](https://github.com/giswqs/timelapse/pulls) "
            "to the [source code](https://github.com/giswqs/timelapse). "
        )
        st.sidebar.title("About")
        st.sidebar.info(
            """
            This web [app](https://share.streamlit.io/giswqs/timelapse/app.py) is maintained by [Qiusheng Wu](https://wetlands.io). You can follow me on social media:
             [GitHub](https://github.com/giswqs) | [Twitter](https://twitter.com/giswqs) | [YouTube](https://www.youtube.com/c/QiushengWu) | [LinkedIn](https://www.linkedin.com/in/qiushengwu).
            This web app URL: <https://timelapse.gishub.org>
        """
        )
